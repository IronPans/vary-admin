...
<script>
    ...
    export default {
        ...
        methods: {
            getStrokeMessage(radius, gapPosition) {
        ...
        computed: {
            ...
            trailStyles() {
                const {animated, lineWidth, value, gapDegree, trackColor} = this;
            ...
            pathStyles() {
                const {animated, lineWidth, lineCap, value, gapDegree, barColor} = this;
                const radius = 50 - lineWidth / 2;
                const len = Math.PI * 2 * radius;
                return {
                    stroke: barColor,
            ...
            pathString() {
                const {lineWidth, gapPosition} = this;
                const radius = 50 - lineWidth / 2;
