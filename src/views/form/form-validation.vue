        ...
        <va-row :gutter="16">
            <va-col :lg="6">
                <va-card header="General Form">
                    <va-form ref="form" :rules="rules" :group="form" inline @submit.native.prevent>
                ...
                <va-card header="Range Validation" class="m-t-20">
                    <va-form ref="rangeForm" :rules="rangeRules" :group="rangeForm" inline @submit.native.prevent>
                        <va-form-item name="minLen">
                            <va-input placeholder="Min 6 chars" v-model="rangeForm.minLen" border></va-input>
                        </va-form-item>
                        <va-form-item name="maxLen">
                            <va-input placeholder="Max 6 chars" v-model="rangeForm.maxLen" border></va-input>
                        </va-form-item>
                        <va-form-item name="minValue">
                            <va-input placeholder="Min value is 6" v-model="rangeForm.minValue" border></va-input>
                        </va-form-item>
                        <va-form-item name="maxValue">
                            <va-input placeholder="Max value is 6" v-model="rangeForm.maxValue" border></va-input>
                        </va-form-item>
                        <va-form-item>
            ...
            <va-col :lg="6">
                <va-card header="Validation Type">
                    <va-form ref="typeForm" :rules="typeRules" :group="typeForm" inline @submit.native.prevent>
                        <va-form-item label-width="80px" name="name" label="Name">
                    ...
                    minLen: [
                        {required: true},
                        {
                            validator(rule, value, callback, source, options) {
                                const errors = [];
                                if (value.length < 6) {
                                    errors.push(new Error('This value is too short. It should have 6 characters or more.'));
                                }
                                callback(errors);
                            }
                        }
                    ...
                    maxLen: [
                        {required: true},
                        {
                            validator(rule, value, callback, source, options) {
                                const errors = [];
                                if (value.length > 6) {
                                    errors.push(new Error('This value is too long. It should have 6 characters or fewer.'));
                                }
                                callback(errors);
                            }
                        }
